...
<div class="main">
    ...
    <div class="group">
        <div class="group_left">
            ...
            <span class="group_span4">Model</span>
        </div>
        <input type="button" value="players in a team" class="btn_03">

        <div class="group_right" style="display:none">
            <div><span class="group_span5">Number of Players</span></div>
            <div><input name="" type="text" class="text_01"></div>
            <div><input name="" type="button" value="Grouping" class="btn_02" clzid="<%=request.getParameter("clzid")%>"
                   crsid="<%=request.getParameter("crsid")%>" schid="<%=request.getParameter("schid")%>"></div>
        </div>
    </div>
    <img src="css/image/line.jpg" width="693" height="1" style="display:block;">
</div>
